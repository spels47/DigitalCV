    ...
    <v-main class="main">
      <v-app-bar color="background lighten-1" app>
        ...
        <v-menu :target="[y]">
          ...
          <v-list v-model:selected="selectedLanguageIndex">
            <!-- <v-list-item-group v-model="selectedLanguageIndex" color="primary"> -->
              <v-list-item color="primary" :value="language.value" v-for="(language, index) in languages" :key="index">
                <v-list-item icon>
      ...
      <v-navigation-drawer v-model="navDrawerOpen" absolute temporary>
        <v-list nav dense v-model:selected="navDrawerGroup" active-class="primary--text text--accent-4">
